    ...
    <section className="py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
          ...
          <div className="flex flex-col items-center">
            <img src="/step2.svg" alt="Step 2" className="w-32 h-32 object-cover mb-4" />
            <div className="bg-orange-100 text-brandOrange rounded-full h-12 w-12 flex items-center justify-center mb-4">
              <span className="text-2xl font-bold">2</span>
            </div>
            <h3 className="text-xl font-bold text-brandOrange mb-2">Create Your Mobile Menu</h3>
            <p className="text-gray-600">Mobile menus are easy to make on DIGITOMENU. Restaurants, cafes, gift shops, and more can benefit from creating a mobile menu!</p>
          </div>
          <div className="flex flex-col items-center">
            <img src="/step3.svg" alt="Step 3" className="w-32 h-32 object-cover mb-4" />
            <div className="bg-orange-100 text-brandOrange rounded-full h-12 w-12 flex items-center justify-center mb-4">
